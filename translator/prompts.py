...
# ─────────────────────────────────────────────────────────────────────────────
# Style reference analysis prompts
# ─────────────────────────────────────────────────────────────────────────────

STYLE_ANALYSIS_SYSTEM_INSTRUCTION = """\
Bạn là chuyên gia phân tích văn học và văn phong. Nhiệm vụ của bạn là đọc các đoạn trích văn học
và phân tích đặc điểm văn phong một cách chi tiết, có thể dùng làm hướng dẫn cho dịch thuật.
Hãy trả lời ĐÚNG theo định dạng được yêu cầu — không thêm giải thích hay văn bản nào khác.
"""

STYLE_ANALYSIS_PROMPT_TEMPLATE = """\
Phân tích văn phong của các đoạn trích từ tác phẩm "{reference_name}" dưới đây.

{chapters_text}

════════════════════════════════════════
YÊU CẦU PHÂN TÍCH VĂN PHONG
════════════════════════════════════════
Hãy phân tích kỹ lưỡng và trả lời ĐÚNG theo định dạng sau.
Không thêm bất kỳ văn bản nào ngoài định dạng này.

###STYLE_PROFILE###
tone: "[Giọng điệu tổng thể, ví dụ: trữ tình / hài hước / u tối / hành động / lãng mạn / triết lý]"
sentence_structure: "[Đặc điểm cấu trúc câu, ví dụ: câu ngắn súc tích / câu dài phức tạp / kết hợp linh hoạt]"
vocabulary: "[Mức độ từ vựng, ví dụ: bình dân / văn học / cổ điển / hiện đại trẻ trung / học thuật]"
narrative_perspective: "[Ngôi kể, ví dụ: ngôi thứ nhất / ngôi thứ ba / đan xen]"
dialogue_style: "[Cách viết hội thoại, ví dụ: tự nhiên đời thường / trang trọng / ngắn gọn súc tích / giàu cảm xúc]"
pacing: "[Nhịp điệu, ví dụ: chậm rãi sâu lắng / nhanh hồi hộp / luân phiên nhanh-chậm]"
distinctive_features: |
  [Liệt kê 3-6 đặc điểm văn phong nổi bật nhất, mỗi đặc điểm một dòng bắt đầu bằng "- "]
style_guide: |
  [Hướng dẫn 4-7 điểm cụ thể để dịch giả tái tạo văn phong này khi dịch sang tiếng Việt.
  Mỗi điểm một dòng bắt đầu bằng "- ". Hãy cụ thể và thực tế.]
example_sentences: |
  [3 câu ví dụ bằng tiếng Việt thể hiện rõ văn phong này. Mỗi câu một dòng bắt đầu bằng "• "]
"""
